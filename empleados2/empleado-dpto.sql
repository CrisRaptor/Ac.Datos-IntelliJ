...
CREATE TABLE departamentos (depno INTEGER PRIMARY KEY,nombre VARCHAR(14), ubicacion VARCHAR(13) );
...
CREATE TABLE empleados (empno INTEGER PRIMARY KEY, nombre VARCHAR(10), puesto VARCHAR(15), depno INTEGER, CONSTRAINT FK_EMPLOYEE_DPT FOREIGN KEY (depno) REFERENCES departamentos(depno) );
