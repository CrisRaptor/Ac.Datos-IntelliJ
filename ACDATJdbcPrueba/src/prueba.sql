...
INSERT INTO destinos (nombre_destino, descripcion, costo_estadia)
...
INSERT INTO agencias (nombre_agencia, direccion_agencia, telefono_agencia)
...
INSERT INTO clientes (nombre_cliente, correo_cliente, telefono_cliente)
VALUES ('Luisa Martínez', 'luisa@email.com', '+1234567890'),
...
INSERT INTO vuelos (origen, destino, fecha_salida, fecha_llegada, costo)
VALUES ('Ciudad A', 'Ciudad B', '2023-12-01', '2023-12-05', 500.00),
...
INSERT INTO clientes_vuelos (cliente_id, vuelo_id)
VALUES (1, 1),
       (1, 2),
       (2, 2),
       (2, 3);
